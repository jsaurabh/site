...
async function render(pathname = "/") {
  ...
  const filePath = cleanPath ? `dist/client/${cleanPath}.html` : "dist/client/index.html";
  try {
...
test("produces a static Pages output", async () => {
  for (const path of [
    "dist/client/index.html",
    "dist/client/articles.html",
    "dist/client/articles/trashnet.html",
